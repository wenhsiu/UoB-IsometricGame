...
public class Start1 extends clickAndDragGameState {
	...
	public Start1(clickAndDragGameManager gm) {
		super();	
		this.gm = gm;
	}
    ...
    public void show() {   
    	// super.show();
		background = new TextureRegion(new Texture("Level1.png"), 0, 0, 652, 759);
