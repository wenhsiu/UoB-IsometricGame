...
public class Start2 extends clickAndDragGameState {
	...
	public Start2(clickAndDragGameManager gm) {
		super();	
		this.gm = gm;
	}
    ...
    public void show() {   
    	// super.show();
		background = new TextureRegion(new Texture("Level2.png"), 0, 0, 652, 759);
