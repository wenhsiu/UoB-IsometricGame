...
public abstract class Property {
	...
	public boolean containPoint(float x, float y) {
		if (x > getPositionX() - boundLeft && x < getPositionX() + boundRight && y > getPositionY() - boundBottom
	...
	private void testPositionX() {

		this.posX = 10; 
		assert(getPositionX() == 10); 

	}

	public static void main(String[] args) {

		//Testing the maze by creating inner classes. 

		Property testProperty = new Property(10, 10, 100){
		...
		assert(testProperty.getPositionX() == 10); 
	}
