...
public class Start3 extends GameState {
	...
	public Start3(GameManager gm) {
		super();	
		this.gm = gm;
		level = new Texture("clickanddrag/level3_button.png");
		levelActive = new Texture("clickanddrag/level3_button2.png");
	...
	public void render (float delta) {    	
        ...
        if (mouseHovering(x, y)) {
            ...
            if (Gdx.input.isButtonPressed(Input.Buttons.LEFT)) {                
                gm.newGameStateByName("GAMELEVEL3");
